...
@Module({
  imports: [PrismaModule, CategoriesModule, ProductModule, VendorModule, DistributerModule, AnalyticCardsModule, AlertTypeModule, InventoryByCategoryModule, PaymentMethodsModule, SalesModule],
